                ...
                <div class="tp-banner" id="home">
                    <ul>
                        ...
                        <!-- <li data-transition="fade" data-slotamount="5" data-masterspeed="700">
                            ...
                            <img src="img/bg/slide_one.jpg" alt="slidebg1" data-bgfit="cover" data-bgposition="center center"
                        ...
                        <li data-transition="fade" data-slotamount="5" data-masterspeed="700">
                            ...
                            <div class="tp-caption sfb slider tp-resizeme slider" data-x="center" data-hoffset="0"
                                ...
                                data-endspeed="300" data-endeasing="Power1.easeIn" data-captionhidden="off" style="z-index: 6">
                                <a href="#" class="btn btn-info btn-lg  btn-large m-r-10">關於我們</a>
                            </div>
                       ...
                       <!--  <li data-transition="fade" data-slotamount="5" data-masterspeed="700">
                            ...
                            <img src="img/bg/picture-2.jpg" alt="slidebg2" data-bgfit="cover" data-bgposition="center center"
                                data-bgrepeat="no-repeat">
                ...
                <div class="p-t-60">
                    ...
                    <div class="section relative">
                        <div class="row text-center">
                            <img src="img/browser-shot.png" alt="" class="resize p-t-60 col-md-12 hidden-xs"
                ...
                <div class="p-t-60 p-b-50">
                    <div id="testomonials" class="owl-carousel row">
                        <div class="item">
                            <div class="col-md-6  col-md-offset-3 text-center">
                                <div class="testimonial-thumb">
                                    <img src="img/testimonial_img1.png" alt="testimonal">
                                </div>
                        ...
                        <div class="item">
                            <div class="col-md-6   col-md-offset-3 text-center">
                                <div class="testimonial-thumb">
                                    <img src="img/testimonial_img2.png" alt="testimonal">
                                </div>
                                <div class="testimonial-user">
                        ...
                        <div class="item">
                            <div class="col-md-6   col-md-offset-3 text-center">
                                <div class="testimonial-thumb">
                                    <img src="img/testimonial_img3.png" alt="testimonal">
                                </div>
                                <div class="testimonial-user">
